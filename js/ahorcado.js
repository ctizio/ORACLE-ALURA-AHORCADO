...
var array = ["ESCUELA", "PROGRAMACION" , "ALURA", "ORACLE", "AMISTAD",
  ...
  "UNIVERSIDAD", "BACHILLERATO", "COLEGIO", "PALOMA", "HIJO",
   ...
   "FARMACIA", "SUPERMERCADO", "PERU", "ARGENTINA", "AZUL",
    "CORONAVIRUS", "SOLEADO", "HELADO", "EXTRAVAGANTE", "AGRICULTURA",
  ...
  "PUERTA", "TOMATE", "ICONO", "IMAGEN", "FOTO",
   "METRO", "AUTOBUS", "AVION", "BOCHO", "BOLILLO", 
    ...
    "LINTERNA", "ZAPATOS", "ZAPATILLAS", "TESORO", "ZOOLOGICO", 
  ...
  "TACO", "CINE", "CALCULADORA", "ROBOT", "SATELITE",
   ...
   "MARTILLO", "HERRAMIENTAS", "PANAMA", "LEYENDA","TULIPAN","CEREZA",
   "AMARILLO","TUCAN","OTORINOLARINGOLOGO","FRUTILLA","PESCADO","PERRO",
   "GATO","CANARIO","AUSTRALIA","ZORRO","UCRANIA","TREBOL","HISPANO","ESTADIO","VOLEY"];
